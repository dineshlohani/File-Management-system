...
class VendorBrandDispatchPieceRequest
{
	protected static $table_name = "vendor_brand_dispatch_piece_request";
	protected static $db_fields = array('id','fiscal_id','date_nepali','date_english','dispatch_time','brand_id','size_L','size_Q','size_P','size_N','size_D','batch_L','batch_Q','batch_P','batch_N','batch_D','vendor_id','dealer_id','vehicle_no','driver_name','remarks');
	public $id;
	public $fiscal_id;
	public $date_nepali;
	public $date_english;
	...
	public static function find_pending_request()
	{
		global $database;
