...
class Filefile
{
	protected static $table_name = "filefile";
	protected static $db_fields = array('id','fiscal_id','reg_no','project','file_type','file_inside','room_no','rack_no','v_number','rack_part_no','remarks','doc_id','documents');
