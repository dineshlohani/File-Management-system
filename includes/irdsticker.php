...
class Irdsticker
{
	protected static $table_name = "ird_sticker";
	protected static $db_fields = array('id','received_from_dept','received_date_nepali','received_date_english','start_no','end_no','quantity','remarks');
	public $id;
