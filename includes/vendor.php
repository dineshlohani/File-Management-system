...
class Vendors
{
	...
	protected static $db_fields = array('id','vendor_name','address','country','vat_no');
	public $id;
	public $vendor_name;
	public $address;
	public $country;
	...
	public static function get_all_vendors($vendor_id)
	{
		global $database;
		...
		{
			$list = self::find_by_id($vendorid);
			$html .= $list->vendor_name;
			$html .= '<br/>';	
		}
		$html .= '</td>';
		return $html;
