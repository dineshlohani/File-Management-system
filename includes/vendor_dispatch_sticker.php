...
class  VendorDispatchSticker
{
	protected static $table_name = "vendor_dispatch_sticker";
	protected static $db_fields = array('id','start_no','end_no','quantity','dispatch_id');
	public $id;
	public $start_no;
	public $end_no;
	public $quantity;
	...
	public static function find_by_dispatch_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where dispatch_id={$id} ");
		return $result_array;
	}
