...
class VendorBrandDispatchRequest
{
	protected static $table_name = "vendor_brand_dispatch_request";
	protected static $db_fields = array('id','fiscal_id','date_nepali','date_english','brand_id','size_L','size_Q','size_P','size_N','size_D','vendor_id','remarks','status','voucher_no');
	public $id;
	public $fiscal_id;
	public $date_nepali;
	public $date_english;
	...
	public static function count_pending_request()
	{
		global $database;
