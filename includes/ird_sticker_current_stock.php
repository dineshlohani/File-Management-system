...
class IrdStickerCurrentStock
{
	protected static $table_name = "ird_sticker_current_stock";
	protected static $db_fields = array('id','stock_quantity','up_id','vol_id');
	public $id;
	...
	public static function find_by_upid_volid($up_id=0,$vol_id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where up_id={$up_id} and vol_id={$vol_id} limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
