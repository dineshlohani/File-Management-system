...
class VendorProduction
{
	protected static $table_name = "vendor_production";
	protected static $db_fields = array('id','fiscal_id','date_nepali','date_english','brand_id','size_L','size_Q','size_P','size_N','size_D','vendor_id','remarks');
	public $id;
	public $fiscal_id;
	public $date_nepali;
	public $date_english;
