...
class Upinfo
{
	protected static $table_name = "up_info";
	protected static $db_fields = array('id','up_type');
	public $id;
	public $up_type;
	...
	public static function find_by_up_type($uptype)
	{
		global $database;
		$result_array=self::find_by_sql('select * from '.self::$table_name. ' where up_type="'.$uptype.'" limit 1');
		return !empty($result_array)? array_shift($result_array) : false;
	}
