...
class Profile
{
	...
	protected static $db_fields = array('id','district_code','acctype','pan_no','business_name','address','purpose','offcode','taxpayer','tel','eff_reg');
	public $id;
	...
	{
		global $database;
		return self::find_by_sql("select * from profile ");
