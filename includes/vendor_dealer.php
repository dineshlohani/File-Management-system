...
class VendorDealer
{
	protected static $table_name = "vendor_dealer";
	protected static $db_fields = array('id','name','address','vat_no','excise_no','ird_name','vendor_id');
	public $id;
	public $name;
	public $address;
	public $vat_no;
	...
	{
		global $database;
		return self::find_by_sql("select * from ".self::$table_name. " where vendor_id={$id}");
