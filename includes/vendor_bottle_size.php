...
class VendorBottleSize
{
	protected static $table_name = "vendor_bottle_size";
	protected static $db_fields = array('id','name','symbol','quantity','remarks','cartoon_bottle_qty','total_one_cartoon_qty');
	public $id;
	public $name;
	public $symbol;
	public $quantity;
	public $remarks;
	public $cartoon_bottle_qty;
	public $total_one_cartoon_qty;
	...
	public static function find_by_vendor_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where vendor_id={$id} ");
		return $result_array;
	}
