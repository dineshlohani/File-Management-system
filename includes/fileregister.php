...
class Fileregister
{
	protected static $table_name = "fileregister";
	protected static $db_fields = array('id','reg_no','fiscal_id','project','room_no','rack_no','rack_part_no','remarks','doc_id','documents');
	public $id;
	public $fiscal_id;
        public $reg_no;
	public $project;
	...
	public static function find_by_params($doc_id=0,$project=0,$remarks="")
	{
		global $database;
